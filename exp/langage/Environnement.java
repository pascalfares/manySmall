...
/**
 * The envirement of expression each symbol is defined by a stack of expressions
 * for example: x=1; then envirement is {(x,1)} x=2; the envirenment become
 * {(x,[2,1])} The envirement is define by a hierarchie each new block create a
 * sub-envirenment this class is the kernel of the idea of dynamic binding
 */
