...
import exp.exceptions.VarException;
...
public class Var extends Exp {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2865662459478500910L;
	 ...
	 * 
	 * @return retourne la définition de la variable (ie L'expression en tête de
	 *         la pile)
	 */
	public Exp getExp() {
	...
	/**
	 * Evalution de l'expression si la variable est défine alors eval definition
	 * sinon inchangé
	 * 
	...
	/**
	 * Affectation (liaison au sens lambda calcul) attribution d'une expression
	 * à une varialble Pour AOP et l'opérateur # la liason se rajoute aux
	 * liasons précédentes
	 * 
	 * @param e
	 *            definition de la variable (une liaison dans le contexte)
	 */
	 ...
	 *            Le tokenizer
	 * @param ts
	 *            L'environnement de parsing
	 * @throws exp.exp.exceptions.VarException
	 *             Erreur de parsing
