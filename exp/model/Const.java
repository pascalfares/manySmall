...
import exp.exceptions.ConstException;
...
public class Const extends Exp {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3054045317711269514L;
	...
	public Const(Environnement e) {
		super(e);
		// laClasse =
		// java.lang.ClassLoader.getSystemClassLoader().loadClass("Double");
	...
	/**
	 * L'evaluation: Const reste inchangé
	 */
	public Exp eval() {
		return this;
	}
	...
	public static Exp parse(NaopTokenizer mt,
		...
		if (mt.getTok() == Token.CONST) {
			...
			throw (new ConstException("Constante Attendue"));
		}
	}
