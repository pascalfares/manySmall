...
import exp.langage.Langage;
import java.io.*;

/**
 * Programme de test utilisant Le parser du language d'expressions. Ce processus
...
public class Test extends Thread {
	...
	BufferedReader in;
	/** Envoi de l'entrée vers le flux du tokenizer */
	PrintWriter out;
	 ...
	 * 
	 * @param in
	 *            Stream d'entrée de l'interpréteur
	 * @param out
	 *            Stream de sortie vers le tokenizer, en général un tube
	 */
	...
	public static void main(String[] args) throws Exception {
		...
		// Lancement du thread
		t.start();
        //Lancement du thread interpréteur du language
		Langage.parse(pi);		
/*
