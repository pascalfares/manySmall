...
<html>
    ...
    <body>
        ...
        int Nomatiere = Integer.parseInt(request.getParameter("Nomatiere"));
        ...
        List<Etud.EtudiantInfo> etd = ME.avoirEtudiantsUneMatiere(annee, semestre, IdCentre, Nomatiere);
        if (etd.isEmpty()) {
...
%>
        ...
        <b>Etudiants de la matière :" <%out.println(IQ.avoirIntitule(Nomatiere));%> "</b>
        <br><br>
        <table border="1">
            <tr bgcolor="#B3E4FD">
                <td><b>Nodossier</b></td>
