...
<html>
    <head>
        ...
        <title>Etudiants et matières (ordre matière - centre)</title>
    ...
    <body>
        ...
        List<Etud.EtudiantInfo> etd = ME.avoirEtudiantsMatiereOrdre(annee, semestre, IdCentre);
        if (etd.isEmpty()) {
...
%>
        ...
        <b>Etudiants et matières (ordre matière - centre):</b>
