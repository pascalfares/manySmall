...
<html>
    <head>
        ...
        <title>Liste étudiants par spécialité</title>
    ...
    <body>
        ...
        List<Etud.EtudiantInfo> etd = null;
        if (choix == 1) {
            etd = ME.avoirEtudSpecMatiere(annee, semestre, IdCentre, spec);
        }
        if (choix == 0) {
            etd = ME.avoirEtudSpec(annee, semestre, IdCentre, spec);
        }
...
%>
        ...
        <b>Liste étudiants par spécialité: " <%out.println(IQ.avoirNomSpec(spec));%>"</b>
