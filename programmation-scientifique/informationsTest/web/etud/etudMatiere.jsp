...
<html>
    <head>
        ...
        <title>Etudiants et matières (ordre centre - étudiant)</title>
    ...
    <body>
        ...
        List<Etud.EtudiantInfo> etd = ME.avoirEtudiantsMatiere(annee, semestre, IdCentre);
        if (etd.isEmpty()) {
...
%>
        ...
        <b>Etudiants et matières (ordre centre - étudiant):</b>
