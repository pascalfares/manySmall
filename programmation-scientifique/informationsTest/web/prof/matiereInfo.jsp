...
<html>
    ...
    <body>
        ...
        List<Prof.Professeur> pro = MP.avoirProfsUneMatiere(annee, semestre, IdCentre, Nomatiere);
        if (pro.isEmpty()) {
        ...
        <b>Professeurs de la matière : " <%out.println(IQ.avoirIntitule(Nomatiere));%> "</b>
        <br><br>
        <table border="1">
            <tr bgcolor="#B3E4FD">
                <td><b>No.</b></td>
