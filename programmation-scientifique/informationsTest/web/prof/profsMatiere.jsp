...
<html>
    <head>
        ...
        <title>Professeurs et matières (ordre centre - matière)</title>
    ...
    <body>
        ...
        List<Prof.Professeur> pro = MP.avoirProfsMatiere(annee, semestre, IdCentre);
        if (pro.isEmpty()) {
        ...
        <b>Professeurs et matières (ordre centre - matière):</b>
