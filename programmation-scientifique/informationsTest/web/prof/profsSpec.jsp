...
<html>
    <head>
        ...
        <title>Liste professeurs par spécialité</title>
    ...
    <body>
        ...
        List<Prof.Professeur> pro = null;
        if (choix == 1) {
            pro = MP.avoirProfsSpecMatiere(annee, semestre, IdCentre, spec);
        }
        if (choix == 0) {
            pro = MP.avoirProfsSpec(annee, semestre, IdCentre, spec);
        }
        ...
        <b>Liste professeurs par spécialité: " <%out.println(IQ.avoirNomSpec(spec));%>"</b>
