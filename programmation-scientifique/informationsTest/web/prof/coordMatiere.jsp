...
<html>
    <head>
        ...
        <title>Coordinateurs des matières</title>
    ...
    <body>
        ...
        List<Prof.Professeur> pro = MP.avoirCoordinateurs(annee, semestre, IdCentre);
        if (pro.isEmpty()) {
            out.println("Pas de données à imprimer.");
        } else {
            //out.println(pro.size());
%>
        <table>
            <tr>
        ...
        <b>Coordinateurs des matières:</b>
        ...
        <table border="1">
            ...
            <tr>
                ...
                <td><%=p.getIntitule()%></td>
                <td><%out.println(IQ.avoirChef(p.getNoChef()));%></td>
            </tr>
            <%}%>
        </table>
        <%}%>
